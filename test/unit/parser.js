...
import { OS_MAP, PLATFORMS_MAP, BROWSER_MAP } from '../../src/constants.js';
...
test('Parser.is using constants should pass', (t) => {
  t.is(parser.is(BROWSER_MAP.opera), true);
  t.is(parser.is(PLATFORMS_MAP.desktop), true);
  t.is(parser.is(OS_MAP.MacOS), true);
});
